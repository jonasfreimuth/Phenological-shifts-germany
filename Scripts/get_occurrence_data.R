...
#                                  "month",
#                                  "doy")) %>%
dat.occ.mean <- readRDS("data/DT_after_nonGer_exclusion_SpeciesFilteredAgain.rds") %>% 
  select(matches(c("kingdom",
                   "phylum",
                   "order",
                   "family",
                   "genus",
...
dat.occ.dec <- readRDS("data/DT_after_nonGer_exclusion_SpeciesFilteredAgain.rds") %>% 
  select(matches(c("kingdom",
                   "phylum",
                   "order",
                   "family",
