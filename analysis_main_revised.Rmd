...
sim_int_diff_temp <- apply(
  int_slopes_asyn, 1,
  function(int_slopes_row, vec) {
...
ggplot(sim_int_diff_temp, aes(temp, diff, col = group)) +
...
ggplot(sim_int_diff_year, aes(year, diff, col = group)) +
