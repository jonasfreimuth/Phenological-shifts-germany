...
ph_aov_temp$id.grp[ph_aov_temp$id.grp[, 4] < 0.1,]
...
ph_aov_year$id.grp[ph_aov_year$id.grp[, 4] < 0.1,]
...
asyn_int_all_corr_plt <- ggplot() +
  ...
  # improve axis labels 
  labs(x = "Asynchrony shift over time [days / year] (\u00B1 95% CI)",
...
ph_aov_int_temp <- TukeyHSD(aov_int_temp)
ph_aov_int_temp$PollDep[ph_aov_int_temp$PollDep[,4] < 0.1,]
...
ph_aov_int_year <- TukeyHSD(aov_int_year)
ph_aov_int_year$PollDep[ph_aov_int_year$PollDep[,4] < 0.1,]
