...
if (!test_run) {
  dat_occ_file   <- "data/f_occurrences_full_pruned_elev.csv"
...
if (!any(file.exists("data/f_occurrences_full_pruned_elev.csv",
                     "data/species_slopes.csv"))) {
  stop("Necessary files are not present.")
}
