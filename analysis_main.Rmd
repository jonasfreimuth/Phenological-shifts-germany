...
# - int.spec.dec: same as spec int slope but on the level of difference 
...
#                   all Butterfly species (to estimate the degree of multivoltism)
