...
# %>% 
#   
#   # order factor levels so that plants come first
  # mutate(id.grp = fct_relevel(id.grp, "Plants", !! recode.vec))
...
if (save.plots) {
  ...
  slopes_grp_temp_mean_plt <- slopes_grp_temp_mean_plt +
    ...
    theme(plot.margin  = unit(c(30, 10, 10, 10), "bigpts"),
          axis.text.x  = element_blank(),
          axis.title.x = element_blank())
